...
const char* ssid = "Kiddy";
const char* password = "nowaybuddy";

const char* mqtt_server = "fa462ba4ab664fe6a8a9c40b953e889f.s1.eu.hivemq.cloud";
const int mqtt_port = 8883;
const char* mqtt_username = "Useitforall123";
const char* mqtt_password = "Useitforall123";
...
void loop() {
  ...
  // Add a delay to control the publish rate
